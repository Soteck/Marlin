...
#define STRING_CONFIG_H_AUTHOR "Soteck" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 401.5, 105 }
...
#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 137.7
  #define XY_DIAG_BD 140.6
  #define XY_SIDE_AD 98.7
